import { PHOTO_LIST_REQUEST, PHOTO_LIST_SUCCESS, PHOTO_LIST_FAIL, PHOTO_DETAILS_REQUEST,PHOTO_DETAILS_SUCCESS, PHOTO_DETAILS_FAIL, PHOTO_DELETE_REQUEST, PHOTO_DELETE_SUCCESS, PHOTO_DELETE_FAIL, PHOTO_CREATE_RESET, PHOTO_CREATE_FAIL, PHOTO_CREATE_SUCCESS, PHOTO_CREATE_REQUEST, PHOTO_UPDATE_REQUEST, PHOTO_UPDATE_SUCCESS, PHOTO_UPDATE_FAIL, PHOTO_UPDATE_RESET } from '../constants/photoConstants';
...
export const photoDetailReducer = (state = { photo: { reviews: [] } }, action) => {
    switch (action.type) {
